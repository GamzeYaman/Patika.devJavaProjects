...
public class Main {
   ...
   static void mod() {
	   ...
	   System.out.print("Sayý giriniz :");
	   int n = scan.nextInt();
	   System.out.print("Kaçla mod alýnacak ? : ");
   ...
   static void rectangle() {
	   Scanner scan = new Scanner(System.in);
	   System.out.print("Diktörtgenin uzun kenarýný giriniz :" );
	   int longSide = scan.nextInt();
	   System.out.print("Diktörtgenin kýsa kenarýný giriniz :" );
	   ...
	   System.out.println("Diktörtgenin Alaný : " + alan);
   }
